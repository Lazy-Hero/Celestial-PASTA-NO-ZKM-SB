...
extends av {
    ...
    protected ah(z z2, double d10, double d11, double d12, double d13, double d14, double d15, float f10) {
        super(z2, d10, d11, d12, 0.0, 0.0, 0.0);
        this.s *= (double)0.01f;
        this.n *= (double)0.01f;
        this.I *= (double)0.01f;
        this.n += 0.2;
        this.B = net.minecraft.k.h.g(((float)d13 + 0.0f) * ((float)Math.PI * 2)) * 0.65f + 0.35f;
        this.C = net.minecraft.k.h.g(((float)d13 + 0.33333334f) * ((float)Math.PI * 2)) * 0.65f + 0.35f;
        this.p = net.minecraft.k.h.g(((float)d13 + 0.6666667f) * ((float)Math.PI * 2)) * 0.65f + 0.35f;
        this.E *= 0.75f;
        this.E *= f10;
        this.M = this.E;
        this.e = 6;
