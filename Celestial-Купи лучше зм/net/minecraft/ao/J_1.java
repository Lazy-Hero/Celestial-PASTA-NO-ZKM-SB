...
extends I {
    ...
    public static J a(List<u> list, Random random, int n2, int n3, int n4, aA aA2, int n5) {
        b b10 = b.a(n2, n3, n4, -1, 0, 0, 5, 7, 5, aA2);
        return J.a(b10) && u.a(list, b10) == null ? new J(n5, random, b10, aA2) : null;
    }
    ...
    public J(int n2, Random random, b b10, aA aA2) {
        super(n2);
        ...
        block8: {
            ...
            block10: {
                ...
                block11: {
                    ...
                    this.a(z2, b10, 4, 2, 0, 4, 5, 4, net.minecraft.u.g.dk.d(), net.minecraft.u.g.dk.d(), false);
                    this.a(z2, b10, 4, 3, 1, 4, 4, 1, net.minecraft.u.g.dn.d(), net.minecraft.u.g.dn.d(), false);
                    this.a(z2, b10, 4, 3, 3, 4, 4, 3, net.minecraft.u.g.dn.d(), net.minecraft.u.g.dn.d(), false);
                    this.a(z2, b10, 0, 2, 0, 0, 5, 0, net.minecraft.u.g.dk.d(), net.minecraft.u.g.dk.d(), false);
                    this.a(z2, b10, 0, 2, 4, 3, 5, 4, net.minecraft.u.g.dk.d(), net.minecraft.u.g.dk.d(), false);
                    ...
                    n4 = b10.a(new n(this.b(3, 3), this.a(2), this.a(3, 3))) ? 1 : 0;
                    if (arrstring == null) break block10;
                    if (n4 != 0) {
                        this.g = false;
                        this.a(z2, b10, random, 3, 2, 3, net.minecraft.aj.j.an);
                    }
                }
